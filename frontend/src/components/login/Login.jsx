        ...
        <div className="bg-white py-8 px-4 shadow  sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full h-[40px] flex justify-center py-2 px-4  border border-transparent text-sm font-medium  text-white bg-[#38a3a5] hover:bg-[#267779"
              >
                Submit
              </button>
            </div>
            <div className={`${styles.normalFlex} w-full text-sm`}>
              <h4>No Account?</h4>
              <Link to="/sign-up" className="text-blue-600 pl-2 hover:text-blue-600 hover:underline">
                Sign Up
              </Link>
            </div>
          </form>
